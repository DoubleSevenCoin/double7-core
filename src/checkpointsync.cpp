...
// dscoin: sync-checkpoint master key
...
// dscoin: synchronized checkpoint (centrally broadcasted)
...
// dscoin: get last synchronized checkpoint
...
// dscoin: only descendant of current sync-checkpoint is allowed
...
// dscoin: reset synchronized checkpoint to last hardened checkpoint
...
// dscoin: find block wanted by given orphan block
...
// dscoin: verify signature of sync-checkpoint message
...
// dscoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in dscoin)
