...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("doublesevencoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DoubleSevencoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seeddoublesevencoin", "52.79.128.50"},
    {"seed", "52.79.214.187"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseeddoublesevencoin", "52.79.128.50"},
    {"tseed", "52.79.214.187"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DoubleSevencoin is probably already running."), addrBind.ToString().c_str());
        else
