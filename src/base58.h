 ...
 * dscoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 30,  // dscoin: addresses begin with 'D'
        SCRIPT_ADDRESS = 90, // dscoin: addresses begin with 'd'
