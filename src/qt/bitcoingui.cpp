 ...
 * The DoubleSevencoin developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("DoubleSevencoin") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/doublesevencoin"));
    setWindowIcon(QIcon(":icons/doublesevencoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DoubleSevencoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/doublesevencoin"), tr("&About DoubleSevencoin"), this);
    aboutAction->setStatusTip(tr("Show information about DoubleSevencoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for DoubleSevencoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/doublesevencoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DoubleSevencoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DoubleSevencoin addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/doublesevencoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://doublesevencoin.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/doublesevencoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.doublesevencoin.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/doublesevencoin_testnet"));
            setWindowIcon(QIcon(":icons/doublesevencoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/doublesevencoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("DoubleSevencoin client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://doublesevencoin.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.doublesevencoin.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DoubleSevencoin network", "", count));
}
...
{
    QString strTitle = tr("DoubleSevencoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DoubleSevencoin address or malformed URI parameters."),
