...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DoubleSevencoins");
    case mBTC: return QString("Milli-DoubleSevencoins (1 / 1,000)");
    case uBTC: return QString("Micro-DoubleSevencoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
