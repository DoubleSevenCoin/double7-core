...
UNIX BUILD NOTES FOR DOUBLESEVENCOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/doublesevencoin/doublesevencoin
	cd doublesevencoin
...
This will build DoubleSevencoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no doublesevencoin ebuild available in overlay 
...
Take the following steps to build (no UPnP support):
	...
	cd ${DOUBLESEVENCOIN_DIR}
	./autogen.sh
	./configure --without-miniupnpc CXXFLAGS="-i/usr/include/db4.8"
	strip src/doublesevencoind


Notes
-----
The release is built with GCC and then "strip doublesevencoind" to strip the debug
